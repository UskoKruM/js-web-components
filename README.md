# JavaScript: Componentes Nativos (Web Components) | Manejo del DOM (Document Object Model)

Aprende a crear componentes web (Web Components) utilizando funcionalidades nativas de JavaScript, específicamente la función document.createElement() propia de Vanilla JavaScript. Conoce cómo crear tus propios componentes web sin utilizar ningún framework, librería o herramienta externa.
